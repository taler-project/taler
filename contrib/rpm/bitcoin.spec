...
License:	MIT
URL:		https://talercrypto.com/
Source0:	https://talercrypto.com/bin/bitcoin-core-%{version}/bitcoin-%{version}.tar.gz
Source1:	http://download.oracle.com/berkeley-db/db-%{bdbv}.NC.tar.gz

Source10:	https://raw.githubusercontent.com/bitcoin/bitcoin/v%{version}/contrib/debian/examples/bitcoin.conf

#man pages
Source20:	https://raw.githubusercontent.com/bitcoin/bitcoin/v%{version}/doc/man/talerd.1
Source21:	https://raw.githubusercontent.com/bitcoin/bitcoin/v%{version}/doc/man/taler-cli.1
Source22:	https://raw.githubusercontent.com/bitcoin/bitcoin/v%{version}/doc/man/taler-qt.1

#selinux
Source30:	https://raw.githubusercontent.com/bitcoin/bitcoin/v%{version}/contrib/rpm/bitcoin.te
# Source31 - what about taler-tx and bench_bitcoin ???
...
The taler-cli utility allows you to communicate and control a bitcoin daemon
over RPC, the taler-tx utility allows you to create a custom transaction, and
...
mv %{buildroot}%{_bindir}/talerd %{buildroot}%{_sbindir}/talerd

# systemd stuff
mkdir -p %{buildroot}%{_tmpfilesdir}
cat <<EOF > %{buildroot}%{_tmpfilesdir}/bitcoin.conf
d /run/talerd 0750 bitcoin bitcoin -
EOF
...
PID_FILE="/run/talerd/talerd.pid"
EOF
...
[Service]
Type=forking
ExecStart=%{_sbindir}/talerd -daemon -conf=\${CONFIG_FILE} -datadir=\${DATA_DIR} -pid=\${PID_FILE} \$OPTIONS
...
# man pages
install -D -p %{SOURCE20} %{buildroot}%{_mandir}/man1/talerd.1
install -p %{SOURCE21} %{buildroot}%{_mandir}/man1/taler-cli.1
%if %{_buildqt}
install -p %{SOURCE22} %{buildroot}%{_mandir}/man1/taler-qt.1
%endif
...
%attr(0755,root,root) %{_bindir}/taler-qt
...
%attr(0644,root,root) %{_mandir}/man1/taler-qt.1*
%endif
...
%attr(0755,root,root) %{_sbindir}/talerd
...
%attr(0644,root,root) %{_mandir}/man1/talerd.1*

%files utils
%defattr(-,root,root,-)
%license COPYING
%doc COPYING bitcoin.conf.example doc/README.md
%attr(0755,root,root) %{_bindir}/taler-cli
%attr(0755,root,root) %{_bindir}/taler-tx
%attr(0755,root,root) %{_bindir}/bench_bitcoin
%attr(0644,root,root) %{_mandir}/man1/taler-cli.1*
