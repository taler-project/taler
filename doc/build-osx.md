...
1. Clone the bitcoin source code and cd into `bitcoin`
        ...
        git clone https://github.com/taler-project/bitcoin
        cd bitcoin
...
-------
    ...
    ./src/talerd -daemon # Starts the bitcoin daemon.
...
* Building with downloaded Qt binaries is not officially supported. See the notes in [#7714](https://github.com/taler-project/bitcoin/issues/7714)
