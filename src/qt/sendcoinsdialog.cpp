                                 ...
                                 const CAmount& watchBalance, const CAmount& watchUnconfirmedBalance, const CAmount& watchImmatureBalance)
{
    ...
    if(model && model->getOptionsModel())
    {
        //QString balanceStr = BitcoinUnits::format(BitcoinUnits::Unit::TLR_rounded, balance);
...
void SendCoinsDialog::updateSmartFeeLabel()
{
    ...
    changeFeeDialog->ui->labelConf->setText(tr("%1 / %2 blocks").arg(GUIUtil::formatNiceTimeOffset(n*Params().GetConsensus().nPowTargetSpacingBegin)).arg(n));
...
void SendCoinsDialog::updateCardInfo()
{
    ...
    QString feeStr = BitcoinUnits::format(BitcoinUnits::Unit::TLR, txFee);
    ...
    QString amountStr = BitcoinUnits::format(BitcoinUnits::Unit::TLR, currentTransaction.getTotalTransactionAmount() + txFee);
