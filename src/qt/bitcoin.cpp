...
/** Class encapsulating Taler Core startup and shutdown.
...
void BitcoinApplication::initializeResult(bool success)
{
    ...
    if(success)
    {
        ...
        // taler: URIs or payment requests:
...
int main(int argc, char *argv[])
{
    ...
    // taler: links repeatedly have their payment requests routed to this process:
