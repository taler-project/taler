...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Taler
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Taler
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Check for untranslated substitution to make sure Taler Core copyright is not removed by accident
    if (strprintf(COPYRIGHT_HOLDERS, COPYRIGHT_HOLDERS_SUBSTITUTION).find("Taler Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Taler Core developers";
    }
    return strCopyrightHolders;
}
*/
