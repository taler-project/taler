...
{
    MutableTransactionSignatureCreator creator(pwallet, &refundTx, 0, amount, SIGHASH_ALL);
...
UniValue initiateswap(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 2)
        throw std::runtime_error(
            ...
            "    \"fee\"            (numeric) The amount of the contract transaction fee in TLR\n"
            "   }\n"
            ...
            "    \"fee\"            (numeric) The amount of the refund transaction fee in TLR\n"
            "   }\n"
            "}\n"
            "\nExamples:\n"
...
UniValue redeemswap(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            ...
            "  \"Redeem fee\"       (numeric) The amount of the redeem transaction fee in TLR\n"
            "}\n"
            "\nExamples:\n"
